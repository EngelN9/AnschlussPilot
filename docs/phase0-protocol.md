...
| Provider verdict and terms snapshot | `v4-partial / BLOCKED` — two DB replies narrow zero-budget access; DELFI requested project context, whose written reply was sent 2026-08-26, but its original six questions remain `0/6` answered; no provider selected and no retention policy frozen | [`provider-evaluation.md`](provider-evaluation.md) |
