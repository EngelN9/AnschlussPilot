...
| Provider verdict and terms snapshot | `v1-partial / BLOCKED` — public evidence only; no provider selected and no retention policy frozen | [`provider-evaluation.md`](provider-evaluation.md) |
